...
import com.kpsilent.reggie.entity.*;
import com.kpsilent.reggie.mapper.OrderMapper;
import com.kpsilent.reggie.service.*;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        List<OrderDetail> orderDetails = shoppings.stream().map((item) -> {
